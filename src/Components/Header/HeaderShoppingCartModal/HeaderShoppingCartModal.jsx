...
function HeaderShoppingCartModal() {
  return (
    <div className="max-lg:hidden scale-y-0 origin-top opacity-0 duration-300 flex flex-col absolute left-0 top-12 bg-white border border-NeutralN10 rounded-2xl z-10">
