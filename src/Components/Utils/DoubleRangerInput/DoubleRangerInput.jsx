    ...
    <div className="flex flex-col w-full gap-6 mb-6">
      <div className="flex justify-between gap-2 items-center">
        ...
        <div className="text-xs font-semibold text-NeutralN500 flex-center flex-grow gap-3">
          <input dir="ltr" type="number" className="text-base text-NeutralN500 flex-grow pt-1 focus-within:outline-none" value={values[0]} min={0} max={values[1]} step={1000} onChange={(event) => handleInputChange(event, 0)} />
