  ...
  return (
    <>
      ...
      <div className="pt-10 pb-6 px-6 flex-col bg-NeutralN10 border border-NeutralN20 rounded-2xl min-w-[24.375rem] mr-14">
        ...
        {coupon && (
          <form onSubmit={(e) => handleSubmit(e)} className="w-full bg-white rounded-lg border border-NeutralN30 pr-2 py-1 pl-1 flex-center mt-4 hover:border-primary2 focus-within:border-primary2 duration-300">
