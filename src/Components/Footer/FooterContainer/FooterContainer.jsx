  ...
  return (
    <footer className=" bg-NeutralN20 max-md:pt-4 md:pt-10 pb-4 px-4">
      <section className={`${styles.footer} w-full max-w-[101.875rem] mx-auto`}>
        <Logo className={`${styles.logo} max-md:w-16`} />
        ...
        <nav className={`${styles.nav} flex justify-between items-start max-lg:gap-8`}>
          <FooterNavLinks data={helpShopingData} />
          <FooterNavLinks data={customerServicesData} />
          <FooterNavLinks data={anaramNavLinksData} />
        </nav>
        <div className={`${styles.eNamad} flex gap-2 flex-wrap`}>
