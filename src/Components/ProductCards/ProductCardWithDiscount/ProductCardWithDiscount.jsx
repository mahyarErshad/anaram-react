...
function ProductCardWithDiscount() {
  return (
    <figure className={`${styles.card} pt-3 pb-[0.875rem] relative px-3 rounded-t-lg bg-white border border-NeutralN30 flex flex-col cursor-pointer transition-all duration-300`}>
