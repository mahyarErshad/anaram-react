...
const DetailSectionAction = ({ state }) => {
  ...
  return (
    <section className={`justify-self-end bg-NeutralN10 border border-NeutralN10 rounded-2xl ${hasDiscount ? "pt-2 discount-red-flag" : "pt-10"} pb-6 px-6 flex-col gap-7 min-w-[24.375rem]`}>
      {hasDiscount && (
