...
const DetailSectionAction = ({ state }) => {
  ...
  return (
    <section className={`justify-self-end relative bg-NeutralN10 border border-NeutralN10 rounded-2xl ${hasDiscount ? "pt-4 discount-red-flag" : "pt-10"} pb-6 px-6 flex-col gap-7 w-1/4 max-lg:w-full min-w-[17.1875rem] max-lg:hidden`}>
