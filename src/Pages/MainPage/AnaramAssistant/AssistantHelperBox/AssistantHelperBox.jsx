...
function AssistantHelperBox(props) {
  return (
    <div className={`bg-gradient-to-b ${props.gradient} rounded-2xl py-3 px-6 z-10 flex justify-start items-center flex-col gap-2 min-h-[11.4375rem] relative ${styles["background-shape"]}`}>
