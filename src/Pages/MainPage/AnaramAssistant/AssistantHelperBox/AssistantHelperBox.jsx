...
const AssistantHelperBox = ({ className, gradientFrom, gradientTo, number, title, description }) => (
  <div className={`bg-gradient-to-b ${className} ${gradientFrom} ${gradientTo} after:bg-gradient-to-b rounded-2xl py-3 px-6 z-10 flex-col justify-start items-center gap-2 min-h-[11.4375rem] relative ${styles["background-shape"]}`}>
