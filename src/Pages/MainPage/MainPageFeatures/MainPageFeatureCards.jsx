...
function MainPageFeatureCards({ icon, text, className }) {
  return (
    <div className={`flex max-md:flex-col justify-start items-center max-md:gap-2 md:gap-6 flex-grow ${className}`}>
