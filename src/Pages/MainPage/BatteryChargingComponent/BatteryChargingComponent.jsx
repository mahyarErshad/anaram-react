...
function BatteryChargingComponent() {
  ...
  useEffect(() => {
    const calculateScroll = () => {
      ...
      if (scrollPercentage >= 20 && scrollPercentage < 40 && percentage < 25) {
        setPercentage(25);
        setFill("#F14B4B");
        setBars(1);
      } else if (scrollPercentage >= 40 && scrollPercentage < 60 && percentage < 50) {
        setPercentage(50);
        setFill("#FB9117");
        setBars(2);
      } else if (scrollPercentage >= 60 && scrollPercentage < 80 && percentage < 75) {
        setPercentage(75);
        setFill("#F7E11E");
        setBars(3);
      } else if (scrollPercentage >= 80 && percentage < 100) {
        setPercentage(100);
        setFill("#8DD442");
        setBars(4);
