...
function MainPageSmallBanners() {
  return (
    <section className="w-full max-w-[82.5rem] mx-auto mt-[6.5rem] bg-transparent flex-center gap-6">
      <img className="rounded-2xl lg:max-w-[40.5rem]" src={banner1} alt="Banner for advertising batteries for customers" />
      <img className="rounded-2xl lg:max-w-[40.5rem]" src={banner2} alt="Banner for advertising batteries for customers" />
    </section>
  );
}
