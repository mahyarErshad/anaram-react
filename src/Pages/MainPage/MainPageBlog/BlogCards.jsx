...
function BlogCards() {
  return (
    <figure className="rounded-2xl p-4 bg-white border border-primary1">
      ...
      <p className="text-[0.6875rem] text-right w-full leading-6 mt-4 max-w-[17.5rem]">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، </p>
    </figure>
  );
}
